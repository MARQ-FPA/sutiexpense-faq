    ...
    <>
      ...
      <div className="flex flex-col justify-center max-w-full w-full" ref={containerRef}>
        ...
        <div id="rules" className="scroll-m-20 infoContainer">
          ...
          <p>Yes. SutiExpense follows Marquette's expense reimbursement policies. Please review them here: <a className="textLink" target="_blank" href="ExpenseReimbursementSuti.pdf">Expense Reimbursement Policy</a></p>
